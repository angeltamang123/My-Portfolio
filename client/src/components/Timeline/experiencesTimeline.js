          ...
          >
            ...
            <TimelineContent className="overflow-hidden translate-x-[-50%] md:translate-x-0 scale-x-200 md:scale-x-100">
              ...
              >
                ...
                <div className="p-4 scale-x-50 -translate-x-12 normal-phones:scale-x-60 normal-phones:-translate-x-6 lg-phones:scale-x-100 lg-phones:-translate-x-0 w-50 lg-phones:w-full ">
